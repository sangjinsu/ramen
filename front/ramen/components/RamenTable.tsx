...
export default function RamenTable({
  ...
  const recommendData = {
    M: {
      ...
      1: [1400, 330, 25, 55, 25, 1000],
      2: [1700, 330, 35, 55, 25, 1200],
      3: [2000, 330, 50, 55, 25, 1500],
      4: [2500, 330, 60, 55, 25, 1500],
      5: [2700, 330, 65, 55, 25, 1500],
      6: [2600, 330, 65, 55, 25, 1500],
      7: [2500, 330, 65, 55, 25, 1500],
      8: [2200, 330, 60, 55, 25, 1500],
      9: [2000, 330, 60, 55, 25, 1300],
      10: [1900, 330, 60, 55, 25, 1100],
    },
    F: {
      0: [900, 330, 25, 55, 25, 1000],
      1: [1400, 330, 25, 55, 25, 1000],
      2: [1500, 330, 35, 55, 25, 1200],
      3: [1800, 330, 45, 55, 25, 1500],
      4: [2000, 330, 55, 55, 25, 1500],
      5: [2000, 330, 55, 55, 25, 1500],
      6: [2000, 330, 55, 55, 25, 1500],
      7: [1900, 330, 50, 55, 25, 1500],
      8: [1700, 330, 50, 55, 25, 1500],
      9: [1600, 330, 50, 55, 25, 1300],
      10: [1500, 330, 50, 55, 25, 1100],
    },
  };
